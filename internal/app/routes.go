...
func (s *Server) registerResourceRoutes() {
	...
	s.authenticatedAPIFunc("GET /api/worlds/{world_id}/entities/{entity_id}/sheet", s.handleGetWorldEntitySheet)
	s.authenticatedAPIFunc("PUT /api/worlds/{world_id}/entities/{entity_id}/logical-state", s.handlePutWorldEntityLogicalState)
	...
	s.authenticatedAPIFunc("GET /api/worlds/{world_id}/available-entities", s.handleListAvailableEntities)
	...
	s.authenticatedAPIFunc("POST /api/worlds/{world_id}/terra/continue", s.handleContinueTerra)
	s.authenticatedAPIFunc("POST /api/worlds/{world_id}/agent/continue", s.handleContinueAgent)
	...
	s.authenticatedAPIFunc("POST /api/worlds/{world_id}/interactions/{interaction_id}/preview", s.handlePreviewInteractionConsequence)
	s.authenticatedAPIFunc("POST /api/worlds/{world_id}/interactions/{interaction_id}/resolve", s.handleResolveInteraction)
	s.authenticatedAPIFunc("POST /api/worlds/{world_id}/interactions/{interaction_id}/terra/decide", s.handleDecideTerraInteraction)
	s.authenticatedAPIFunc("POST /api/worlds/{world_id}/interactions/{interaction_id}/agent/resolve", s.handleResolveAgentInteraction)
