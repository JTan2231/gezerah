...
describe("ChatGPTWorldStartView", () => {
  test("offers an honest, copyable route through Build", () => {
    const prompt = createChatGPTWorldStartPrompt("https://dnd.example/build");
    ...
    expect(html).toContain("https://dnd.example/build");
    expect(html).toContain("I will sign in and make each change myself.");
    expect(html).toContain("help me choose ChatGPT as Dungeon Master");
