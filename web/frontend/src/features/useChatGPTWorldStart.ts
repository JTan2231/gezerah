...
export function createChatGPTWorldStartPrompt(buildURL: string): string {
  return [
    `Help me start a new World in dnd at ${buildURL}.`,
    ...
    "When my World and Character are ready, guide me into Play, help me choose ChatGPT as Dungeon Master, and begin.",
  ].join(" ");
}
