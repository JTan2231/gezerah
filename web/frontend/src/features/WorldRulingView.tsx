      ...
      <footer className="ruling-actions">
        {model.terraEnabled ? (
          <button
            ...
            type="button"
            disabled={model.saving !== null || !model.rulesReady}
            onClick={() => actions.prepare("generate")}
          >
            {model.saving === "generate"
              ? "Terra is deciding…"
              : model.preview === null
          ...
          <button
            ...
            onClick={() => actions.prepare("compile")}
          >
