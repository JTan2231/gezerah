...
Wrought uses native username/password accounts, Argon2id password hashes, opaque revocable server
...
| Caller-supplied UUID identity | `X-WROUGHT-User-ID` cannot authenticate or override a session.                                                                                                                                    |
